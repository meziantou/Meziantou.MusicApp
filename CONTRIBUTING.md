...
Please read these guidelines before contributing to meziantou/Meziantou.MusicApp:
...
If you have questions about how to use meziantou/Meziantou.MusicApp, please open a GitHub issue.
...
- Check that new and updated code follows meziantou/Meziantou.MusicApp's existing code formatting and naming standard
- Run meziantou/Meziantou.MusicApp's unit tests to ensure no existing functionality has been affected
...
By contributing your code to meziantou/Meziantou.MusicApp you grant Gérald Barré a non-exclusive, irrevocable, worldwide,
