...
/// <summary>
/// Helper class providing common functionality for serving cached images
/// </summary>
public static class ImageCacheHelper
{
    /// <summary>
    /// Sets HTTP cache headers for image responses based on file modification time
    /// </summary>
    ...
    /// <summary>
    /// Checks if the client's cached version is still valid based on If-Modified-Since header
    /// </summary>
