...
public sealed class MusicCatalog
{
    ...
    internal static async Task<MusicCatalog> Create(SerializableMusicCatalog serializableCatalog, FullPath rootPath, FullPath coverArtCachePath, ILogger<MusicCatalog> logger)
    {
